...
\begin{figure}[H]
  \centering  
  \includegraphics[width=0.7\columnwidth]{ard.jpg}
...
We want to know if, and by how much, the environment affects the results. We also investigate how and if we can use the \texttt{analogRead} output to find entropy and how we test for randomness. 
  ...
  \begin{figure}[h!]
    ...
    \subfloat[Sample from Ard3 taken on the desktop computer]{
      ...
      \includegraphics[width=0.55\columnwidth]{allpinsdesktop2.png}
    }
    \subfloat[Sample from Ard3 taken on the D620]{
      \label{fig:allpinsd620}
      \includegraphics[width=0.55\columnwidth]{allpinsd6202.png}
    }
...
\begin{figure}[H]
  \centering  
  \includegraphics[width=0.7\columnwidth]{environment.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\columnwidth]{ard3gfgarage2.png}
...
\begin{figure}[h!]
  ...
  %   \includegraphics[width=0.7\columnwidth]{Room_1500-1700_zoom.png}
  % }

  % \subfloat[1000 readings from ard3 connected to the D620 laptop]{
  %   \label{fig:ard3zoomroom}
  %   \includegraphics[width=0.7\columnwidth]{RoomZoom_9des.png}
  % }
...
\begin{figure}[h!]
  \centering  
  \includegraphics[width=0.6\columnwidth]{heating.png}
...
%\begin{figure}[h!]
%  \centering  
%  \includegraphics[width=0.6\columnwidth]{freezer.png}
...
%\begin{figure}[h!]
%  \centering  
%  \includegraphics[width=0.6\columnwidth]{fridge.png}
...
%\end{figure}
  ...
  \begin{figure}[h!]
    ...
    \subfloat[Fridge (approx. 1C)]{
      \includegraphics[width=0.5\columnwidth]{fridge.png}
      \label{fig:ard1fridge}
    }
    \subfloat[Freexer (approx. -11C)]{
      \includegraphics[width=0.5\columnwidth]{freezer.png}
      \label{fig:ard1freezer}
    }
