...
and show that the results are statistically significant and we can reject it as non-random. These are the average over three consequtive runs in the same setting\footnote{Study of the author}.

  \begin{table}[H]
    \begin{center}
      \begin{tabular}{| l | l |}
        \hline
        Statistical test & $X$ statistic & Accepted & Bitrate \\
        \hline
        \hline
        Monobit & 903.847 & Not accepted &  \\
        \hline
      \end{tabular}
    \end{center}
